...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Факултет-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Име на студент</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Учебен предмет</label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
