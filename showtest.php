...
$sql = "SELECT * from tbltest where SubjectId=$subid;";
...
if($query->rowCount() > 0){
    foreach($results as $result) {
        ?>
        <ul class="child-nav">
           <li><a href="show-question.php?TestId=<?php echo $result->TestId;?>"><?php echo htmlentities($result->TestName);?></a></li>
      </ul>
