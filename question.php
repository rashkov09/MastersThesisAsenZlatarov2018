...
echo '<ol>';
    ...
    echo '<li><input type="radio" name="answer" value="ans1" checked="">'.$ans1.'</input></li>';
    echo '<li><input type="radio" name="answer" value="ans2" checked="">'.$ans2.'</input></li>';
    echo '<li><input type="radio" name="answer" value="ans3" checked="">'.$ans3.'</input></li>';
    echo '<li><input type="radio" name="answer" value="ans4" checked="">'.$ans4.'</input></li>';
