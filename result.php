                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Резултати</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
{   ?>
<p><b>Име на студент :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Факултетен номер :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Специалност:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
                                                <th scope="row" colspan="2">Обща оценка</th>
<td><b><?php echo htmlentities($totlcount); ?></b> out of <b><?php echo htmlentities($outof=($cnt-1)*100); ?></b></td>
                                                        </tr>
<tr>
                                                <th scope="row" colspan="2">Процент</th>           
                                                            <td><b><?php echo  htmlentities($totlcount*(100)/$outof); ?> %</b></td>
                                                             </tr>
<tr>
                                                <th scope="row" colspan="2">Сваляне на резултат</th>           
                                                            <td><b><a href="download-result.php">Сваляне </a> </b></td>
                                                             </tr>

 <?php } else { ?>     
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Внимание!</strong> Все още няма публикувани резултати.
 <?php }
?>
                                        </div>
 <?php 
...
<?php
echo htmlentities("Грешен факултетен номер");
 }
?>
                                        </div>
                                    ...
                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <a href="udashboard.php">Основен панел</a>
                                                            </div>
                                                        </div>
