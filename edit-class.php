...
<html lang="en">
    <head>
        ...
        <title>Редактиране на учебна група</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Редактиране на учебна крупа</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><a href="#">Учебни</a></li>
            							<li class="active">Редактиране на учебни групи</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Редактиране на учебна група</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Специалност</label>
                                                		<div class="">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Факултет</label>
                                                        <div class="">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="update" class="btn btn-success btn-labeled">Редактиране<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
