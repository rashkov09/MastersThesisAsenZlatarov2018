...
$test=$_POST['test']; 
$status=1;
$sql="INSERT INTO  tbltestcombination(SubjectId,TestId,Status) VALUES(:subject,:test,:status)";
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Предмети</li>
                                        <li class="active">Добавяне на тест в предмет</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Добавяне на тест в предмет</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Тест</label>
                                                        <div class="col-sm-10">
 <select name="test" class="form-control" id="default" required="required">
<option value="">Избор</option>
