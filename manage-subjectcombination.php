...
$query->execute();
$msg="Обучението беше активирано  успешно";
}
...
$query->bindParam(':status',$status,PDO::PARAM_STR);
$query->execute();
$msg="Обучението беше деактивирано успешно";
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Управление на обучение</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Обучение</li>
            							<li class="active">Управление на обучение</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Информация за предмети и учебни групи</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->ClassName);?> &nbsp; Факултет-<?php echo htmlentities($result->Section);?></td>
...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('Искате ли да активирате това обучение');"><i class="fa fa-check" title="Активиране"></i> </a><?php } else {?>

<a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="confirm('Искате ли да деактивирате това обучение');"><i class="fa fa-times" title="Деактивиране"></i> </a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
